  ...
  const ToggleLessonTime = async (Time: 30 | 45) => {
    ...
    try {
      ...
      if ((Error as Error).message.includes('Unauthorized')) {
        // Handle auth error - could redirect to login or show specific message
        alert('You need to be logged in to change settings')
      } else {
