...
const Navbar = ({ logoHref }: { logoHref?: string }) => {
  ...
  const SpotifyPlaylistUrl = "https://open.spotify.com/playlist/02hdeJ4xNLqi0ek760Znxh?si=2065a5384a0e4c51";
            ...
            >
              <div className="p-4 flex items-center justify-between border-b border-white/10">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-sm ${_SpaceGrotesk.className} text-white`}>
